//Needs fixing... 
//setup the arsenal for a player locally.
...
//Close down arsenal eventhandler
		...
		player linkItem "TFAR_anprc152"; //To prevent the ACE arsenal bug that removes the radio...
...
//Attachments=====================================
	...
	"rhsusf_acc_ACOG_RMR", //Squadleader /teamleader
	
	"rhsusf_acc_ARDEC_M240",
	"rhsusf_acc_ELCAN", 		//Autorifleman
	"rhsusf_acc_ELCAN_ard",		//Autorifleman
...
"FRXA_tf_rt1523g_big_Ranger_Green",
	...
	[_object, _player, false] call ace_arsenal_fnc_openBox
