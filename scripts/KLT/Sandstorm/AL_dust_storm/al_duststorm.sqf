...
[[],"scripts\klt\sandstorm\AL_dust_storm\alias_duststorm_effect.sqf"] remoteExec ["execVM",0,true];

if (_dust_wall) then 
{
	_rand_pl = [] execVM "scripts\klt\sandstorm\AL_dust_storm\alias_hunt.sqf";
	...
	[[_stormsource,_duration_duststorm,_x_dev,_y_dev],"scripts\klt\sandstorm\AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["execVM",0,true];
	...
	if (_lethal_wall) then {[_stormsource,_x_dev,_y_dev] execvm "scripts\klt\sandstorm\AL_dust_storm\lethal_wall.sqf"};
