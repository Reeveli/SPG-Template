/*
 * Author: HallyG, modified by Reeveli
 * Client side function to start the .paa file viewer.
 * Can be run either from the editor itself or eidtor preview mission
 *
 * Arguments: NONE
 *
 * Return Value: NONE
 *
 * Example:
 * [] call Rev_fnc_icon_viewer
 *
 1.1
	Improved safety performance
 1.0.1
	First safety check changed to use is3DEN varibale
 */

//Safety check
if !(is3DEN|| is3DENPreview) exitWith {
	playSound "FD_Start_F";
	systemchat "Icon viewer can only be viewed either in editor or in editor preview!"
};
