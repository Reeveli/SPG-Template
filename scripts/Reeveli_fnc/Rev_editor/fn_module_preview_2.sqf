 ...
 *
 * Example:
 * [_this select 0,_this select 1] call Rev_fnc_module_preview_2
 *
 */
...
[
	...
	[
		...
		["SLIDER:RADIUS",["Example radius slider","This feature only works when module is placed on a unit"],[0,400,200,0,_position,[1,0,0,1]],false]
	],
	{
