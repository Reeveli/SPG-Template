 ...
 *
 1.0.1
	Fixed some typos
	Added keypress function code to EDIT:MULTI and EDIT:CODE examples, same as EDIT
 */
...
[
	...
	[
		...
		["COMBO",["Example combo box","This control will return whatever value is selected"],[[1,2,3],[["Value1","Tooltip 1","\a3\Ui_f\data\GUI\Cfg\Hints\Zeus_ca.paa",[0.2,0.8,1,1]],["Value 2","Tooltip 2"],["Value 3","Tooltip 3"]],0],true],
		["EDIT",["Example edit box","This control has an optional function being called every keypress"],["Default text",{hintSilent str _this select 0}],true],
		["EDIT:MULTI",["Example multiline edit box","In this example the box size is set to 3 lines"],["Bigger box size for longers texts",{hintSilent str _this select 0},3],true],
		["EDIT:CODE",["Example multiline edit box with code assist","This control provides scripting autocompletion"],["Try to write some scripting commands",{hintSilent str _this select 0},3],true],
