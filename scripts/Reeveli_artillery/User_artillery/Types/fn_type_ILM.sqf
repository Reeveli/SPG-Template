...
if (_number > Rev_arty_ILM_amount) then {_number = Rev_arty_ILM_amount; [{playSound "FD_Start_F"; params ["_ammo_amount"];hint format ["Maximum available ordance of %1 used!",_ammo_amount];}, [Rev_arty_ILM_amount]] call CBA_fnc_execNextFrame;};
