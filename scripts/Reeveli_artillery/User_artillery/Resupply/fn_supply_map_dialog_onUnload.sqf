 ...
 *
 * Example:
 * [_display,_exitCode] call Rev_arty_fnc_supply_map_dialog_onUnload
 *
 */
...
private _attachment = lnbData [6023, [lbCurSel 6023,1]];
private _altitude = sliderPosition 6025;
private _start_pos = getMarkerPos 'Rev_arty_sup_dir';

//removing map EH
removeMissionEventHandler ['MapSingleClick', missionNameSpace getVariable ['Rev_arty_sup_map_event',-1]];
//deleting markers
deleteMarkerLocal 'Rev_arty_sup_tgt';
deleteMarkerLocal 'Rev_arty_sup_area';
deleteMarkerLocal 'Rev_arty_sup_dir';
deleteMarkerLocal 'Rev_arty_sup_arrow_1';
deleteMarkerLocal 'Rev_arty_sup_arrow_2';
deleteMarkerLocal 'Rev_arty_sup_arrow_3';
