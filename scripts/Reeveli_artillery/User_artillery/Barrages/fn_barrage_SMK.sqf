...
private _dispersion = _number * 5;
//Start bombarment
for "_i" from 0 to (_number - 1) do {
	[{params ["_pos", "_range","_angle","_dispersion","_index","_number"];[_pos, _range,_angle,_dispersion,_index,_number] call Rev_arty_fnc_shell_SMK;}, [_pos, _range,_angle,_dispersion,_i,_number], ((_i * _delay) + (random 2))] call CBA_fnc_waitAndExecute;
};