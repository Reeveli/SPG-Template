...
class TAW_RscTitle:TAW_RscText {
	style = 0;
	shadow = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
...
class TAW_RscControlsGroupNoScrollbars : TAW_RscControlsGroup {
...
class TAW_RscButtonMenu:TAW_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class TAW_VDMenu {
	...
	class controlsBackground {
		class TitleBackground : TAW_RscText {
		...
		class MainBackground : TAW_RscText {
		...
		class ButtonClose : TAW_RscButtonMenu {
			idc = -1;
			text = "Close";
	...
	class controls {
		...
		//Sliders
		class VD_onFoot_slider : TAW_RscXSliderH {
			idc = INFANTRY_SLIDER;
			text = "";
		...
		class VD_onFoot_Edit : TAW_RscEdit {
			idc = INFANTRY_EDIT;
			text = "";
		...
		class ObjectSyncCheckbox : TAW_RscCheckbox
		{
			idc = 2931;
			x = .32; y = .6;
		...
		class ObjectSynctext : TAW_RscText {
			idc = -1;
			text = "Sync with view";
			x = .345; y = .596;
			w = .35; h = .04;
		...
		class Manager:TAW_RscControlsGroup {
			idc = MANAGER_GROUP;

			x = -0.21; y = .2;
			w = .5; h = 3;
			class Controls {
				class SaveLoadGroup:TAW_RscControlsGroupNoScrollbars {
					idc = SAVELOAD_GROUP;
					...
					class Controls {
						class MyTitleBackground:TAW_RscText {
							colorBackground[] = { "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])" };
							idc = -1;
							x = 0;
							y = 0;
						...
						class SaveButton:TAW_RscButtonMenu {
							text = "Save";
						...
						class HideButton:TAW_RscButtonMenu {
							text = "Hide";
